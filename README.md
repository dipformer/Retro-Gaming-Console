...
Плата **AVR Game board** это Arduino совместимое устройство на микроконтроллере ATmega328 в форм-факторе игровой 
...
## Инициализация
Подключение библиотеки для **AVR Game board** осуществляется в два этапа. Первый - это собственно команда 
...
Каждая ячейка массива содержит один байт данных, или 8 бит. Каждяй бит будет определять, будет ли светиться 
...
Параметр функции `v` может изменяться от 0 до 15, где 0 соответствует полному затемнению отображения. Установка 
